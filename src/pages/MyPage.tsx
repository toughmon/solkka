  ...
  return (
    <div className="bg-[#fbf9f8] text-[#313332] min-h-screen pb-32 font-body" style={{ minHeight: 'max(884px, 100dvh)' }}>
      ...
      <nav className="fixed bottom-0 left-0 w-full flex justify-around items-center px-4 pb-6 pt-3 bg-[#fbf9f8]/80 dark:bg-[#1a1c1e]/80 backdrop-blur-xl rounded-t-[1.5rem] z-50 shadow-[0_-4px_40px_rgba(49,51,50,0.06)]">
        <Link className="flex flex-col items-center justify-center text-[#5e5f5f] dark:text-[#909191] px-5 py-2 hover:text-[#4c6272] dark:hover:text-[#a5c8df] transition-colors scale-95 active:scale-90 duration-300" to="/">
        ...
        <Link className="flex flex-col items-center justify-center text-[#5e5f5f] dark:text-[#909191] px-5 py-2 hover:text-[#4c6272] dark:hover:text-[#a5c8df] transition-colors scale-95 active:scale-90 duration-300" to="/search">
        ...
        <Link className="flex flex-col items-center justify-center text-[#5e5f5f] dark:text-[#909191] px-5 py-2 hover:text-[#4c6272] dark:hover:text-[#a5c8df] transition-colors scale-95 active:scale-90 duration-300" to="/create">
        ...
        <Link className="flex flex-col items-center justify-center bg-[#4c6272] text-white dark:bg-[#a5c8df] dark:text-[#1a1c1e] rounded-[1.5rem] px-5 py-2 transition-all duration-300" to="/mypage">
